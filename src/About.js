...
const About = () => (
  <div className="flex flex-column flex-align-items-center pad-30 montserrat">
    ...
    <div className="pad-30 max-width-300 text-align-left">
      {`I'm a NYC-based software engineer with a passion for delivering great
        user experiences, and a knack for automating everything.
        In my spare time, I enjoy working on side projects, reading and
        learning. Otherwise, I'm improving my kill/death rate in
